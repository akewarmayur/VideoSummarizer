...
import re
from sceneDetection.modelFiles.utils import Utils
import sceneDetection.modelFiles.params as yamnet_params
import sceneDetection.modelFiles.yam as yamnet_model
...
class SceneDetection:
    ...
    def load_model(self):
        ...
        yamnet.load_weights('sceneDetection/modelFiles/model.h5')
        yamnet_classes = yamnet_model.class_names('sceneDetection/modelFiles/yam_class_map.csv')
    ...
    def sceneAudioFeatures(self, df, scene):
    ...
    def detect_scenes(self, input_video, window, save_scenes):
        ...
        try:
            ...
            try:
                ...
                pass
            sceneswithAF = self.sceneAudioFeatures(df, scenesDF)
            return sceneswithAF
